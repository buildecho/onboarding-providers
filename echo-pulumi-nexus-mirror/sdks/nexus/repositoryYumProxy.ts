...
export class RepositoryYumProxy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositoryYumProxyState, opts?: pulumi.CustomResourceOptions): RepositoryYumProxy {
        return new RepositoryYumProxy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nexus:index/repositoryYumProxy:RepositoryYumProxy';

    /**
     * Returns true if the given object is an instance of RepositoryYumProxy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RepositoryYumProxy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RepositoryYumProxy.__pulumiType;
    }

    /**
     * Cleanup policies
     */
    public readonly cleanups!: pulumi.Output<outputs.RepositoryYumProxyCleanup[] | undefined>;
    /**
     * HTTP Client configuration for proxy repositories
     */
    public readonly httpClient!: pulumi.Output<outputs.RepositoryYumProxyHttpClient>;
    /**
     ...
     */
    public readonly negativeCache!: pulumi.Output<outputs.RepositoryYumProxyNegativeCache>;
    /**
     ...
     */
    public readonly proxy!: pulumi.Output<outputs.RepositoryYumProxyProxy>;
    /**
     ...
     */
    public readonly storage!: pulumi.Output<outputs.RepositoryYumProxyStorage>;
    /**
     * Contains signing data of repositores
     */
    public readonly yumSigning!: pulumi.Output<outputs.RepositoryYumProxyYumSigning | undefined>;
    ...
    constructor(name: string, argsOrState?: RepositoryYumProxyArgs | RepositoryYumProxyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RepositoryYumProxyState | undefined;
            ...
            const args = argsOrState as RepositoryYumProxyArgs | undefined;
        ...
        super(RepositoryYumProxy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
