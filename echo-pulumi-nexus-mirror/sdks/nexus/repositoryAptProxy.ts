...
export class RepositoryAptProxy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositoryAptProxyState, opts?: pulumi.CustomResourceOptions): RepositoryAptProxy {
        return new RepositoryAptProxy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nexus:index/repositoryAptProxy:RepositoryAptProxy';

    /**
     * Returns true if the given object is an instance of RepositoryAptProxy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RepositoryAptProxy {
     ...
     * Cleanup policies
     */
    public readonly cleanups!: pulumi.Output<outputs.RepositoryAptProxyCleanup[] | undefined>;
    /**
     ...
     */
    public readonly httpClient!: pulumi.Output<outputs.RepositoryAptProxyHttpClient>;
    /**
     ...
     */
    public readonly negativeCache!: pulumi.Output<outputs.RepositoryAptProxyNegativeCache>;
    /**
     ...
     */
    public readonly proxy!: pulumi.Output<outputs.RepositoryAptProxyProxy>;
    /**
     ...
     */
    public readonly storage!: pulumi.Output<outputs.RepositoryAptProxyStorage>;
    ...
    constructor(name: string, argsOrState?: RepositoryAptProxyArgs | RepositoryAptProxyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as RepositoryAptProxyArgs | undefined;
