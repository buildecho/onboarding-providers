...
export class RepositoryRubygemsProxy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositoryRubygemsProxyState, opts?: pulumi.CustomResourceOptions): RepositoryRubygemsProxy {
        return new RepositoryRubygemsProxy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nexus:index/repositoryRubygemsProxy:RepositoryRubygemsProxy';

    /**
     * Returns true if the given object is an instance of RepositoryRubygemsProxy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RepositoryRubygemsProxy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RepositoryRubygemsProxy.__pulumiType;
    }

    /**
     * Cleanup policies
     */
    public readonly cleanups!: pulumi.Output<outputs.RepositoryRubygemsProxyCleanup[] | undefined>;
    /**
     * HTTP Client configuration for proxy repositories
     */
    public readonly httpClient!: pulumi.Output<outputs.RepositoryRubygemsProxyHttpClient>;
    /**
     ...
     */
    public readonly negativeCache!: pulumi.Output<outputs.RepositoryRubygemsProxyNegativeCache>;
    /**
     ...
     */
    public readonly proxy!: pulumi.Output<outputs.RepositoryRubygemsProxyProxy>;
    /**
     ...
     */
    public readonly storage!: pulumi.Output<outputs.RepositoryRubygemsProxyStorage>;
    ...
    constructor(name: string, argsOrState?: RepositoryRubygemsProxyArgs | RepositoryRubygemsProxyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RepositoryRubygemsProxyState | undefined;
            ...
            const args = argsOrState as RepositoryRubygemsProxyArgs | undefined;
        ...
        super(RepositoryRubygemsProxy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
