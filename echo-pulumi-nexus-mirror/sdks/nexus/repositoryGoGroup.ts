...
export class RepositoryGoGroup extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositoryGoGroupState, opts?: pulumi.CustomResourceOptions): RepositoryGoGroup {
        return new RepositoryGoGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nexus:index/repositoryGoGroup:RepositoryGoGroup';

    /**
     * Returns true if the given object is an instance of RepositoryGoGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RepositoryGoGroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RepositoryGoGroup.__pulumiType;
    }

    /**
     * Configuration for repository group
     */
    public readonly group!: pulumi.Output<outputs.RepositoryGoGroupGroup>;
    /**
     ...
     */
    public readonly storage!: pulumi.Output<outputs.RepositoryGoGroupStorage>;
    ...
    constructor(name: string, argsOrState?: RepositoryGoGroupArgs | RepositoryGoGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RepositoryGoGroupState | undefined;
            resourceInputs["group"] = state ? state.group : undefined;
            resourceInputs["name"] = state ? state.name : undefined;
            resourceInputs["online"] = state ? state.online : undefined;
            resourceInputs["storage"] = state ? state.storage : undefined;
        } else {
            const args = argsOrState as RepositoryGoGroupArgs | undefined;
        ...
        super(RepositoryGoGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
