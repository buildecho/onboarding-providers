...
export class RepositoryP2Proxy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositoryP2ProxyState, opts?: pulumi.CustomResourceOptions): RepositoryP2Proxy {
        return new RepositoryP2Proxy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nexus:index/repositoryP2Proxy:RepositoryP2Proxy';

    /**
     * Returns true if the given object is an instance of RepositoryP2Proxy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RepositoryP2Proxy {
     ...
     * Cleanup policies
     */
    public readonly cleanups!: pulumi.Output<outputs.RepositoryP2ProxyCleanup[] | undefined>;
    /**
     * HTTP Client configuration for proxy repositories
     */
    public readonly httpClient!: pulumi.Output<outputs.RepositoryP2ProxyHttpClient>;
    /**
     ...
     */
    public readonly negativeCache!: pulumi.Output<outputs.RepositoryP2ProxyNegativeCache>;
    /**
     ...
     */
    public readonly proxy!: pulumi.Output<outputs.RepositoryP2ProxyProxy>;
    /**
     ...
     */
    public readonly storage!: pulumi.Output<outputs.RepositoryP2ProxyStorage>;
    ...
    constructor(name: string, argsOrState?: RepositoryP2ProxyArgs | RepositoryP2ProxyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RepositoryP2ProxyState | undefined;
            ...
            const args = argsOrState as RepositoryP2ProxyArgs | undefined;
