...
export class RepositoryNugetGroup extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositoryNugetGroupState, opts?: pulumi.CustomResourceOptions): RepositoryNugetGroup {
        return new RepositoryNugetGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nexus:index/repositoryNugetGroup:RepositoryNugetGroup';

    /**
     * Returns true if the given object is an instance of RepositoryNugetGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RepositoryNugetGroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RepositoryNugetGroup.__pulumiType;
    }

    /**
     * Configuration for repository group
     */
    public readonly group!: pulumi.Output<outputs.RepositoryNugetGroupGroup>;
    /**
     ...
     */
    public readonly storage!: pulumi.Output<outputs.RepositoryNugetGroupStorage>;
    ...
    constructor(name: string, argsOrState?: RepositoryNugetGroupArgs | RepositoryNugetGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RepositoryNugetGroupState | undefined;
            resourceInputs["group"] = state ? state.group : undefined;
            resourceInputs["name"] = state ? state.name : undefined;
            resourceInputs["online"] = state ? state.online : undefined;
            resourceInputs["storage"] = state ? state.storage : undefined;
        } else {
            const args = argsOrState as RepositoryNugetGroupArgs | undefined;
        ...
        super(RepositoryNugetGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
