...
exports.BlobstoreFile = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class BlobstoreFile extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new BlobstoreFile(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.BlobstoreFile = BlobstoreFile;
/** @internal */
BlobstoreFile.__pulumiType = 'nexus:index/blobstoreFile:BlobstoreFile';
//# sourceMappingURL=blobstoreFile.js.map