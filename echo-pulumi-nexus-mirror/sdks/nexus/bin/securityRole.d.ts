...
export declare class SecurityRole extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecurityRoleState, opts?: pulumi.CustomResourceOptions): SecurityRole;
    /**
     * Returns true if the given object is an instance of SecurityRole.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SecurityRole;
    /**
