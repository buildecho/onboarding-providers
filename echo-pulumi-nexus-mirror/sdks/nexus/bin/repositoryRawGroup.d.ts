...
export declare class RepositoryRawGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositoryRawGroupState, opts?: pulumi.CustomResourceOptions): RepositoryRawGroup;
    /**
     * Returns true if the given object is an instance of RepositoryRawGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RepositoryRawGroup;
    /**
     * Configuration for repository group
     */
    readonly group: pulumi.Output<outputs.RepositoryRawGroupGroup>;
    /**
     ...
     */
    readonly storage: pulumi.Output<outputs.RepositoryRawGroupStorage>;
    /**
