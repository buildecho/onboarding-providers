...
exports.RepositoryRawGroup = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class RepositoryRawGroup extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new RepositoryRawGroup(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.RepositoryRawGroup = RepositoryRawGroup;
/** @internal */
RepositoryRawGroup.__pulumiType = 'nexus:index/repositoryRawGroup:RepositoryRawGroup';
//# sourceMappingURL=repositoryRawGroup.js.map