    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (_packageRef === undefined) {
            ...
            if (_packageRef === undefined) {
                ...
                params.setName("nexus");
                params.setVersion("2.6.0");
                params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2RhdGFkcml2ZXJzL25leHVzIiwidmVyc2lvbiI6IjIuNi4wIn19"), c => c.charCodeAt(0)));
