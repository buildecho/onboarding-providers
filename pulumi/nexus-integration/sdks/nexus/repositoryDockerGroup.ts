...
export class RepositoryDockerGroup extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositoryDockerGroupState, opts?: pulumi.CustomResourceOptions): RepositoryDockerGroup {
        return new RepositoryDockerGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nexus:index/repositoryDockerGroup:RepositoryDockerGroup';

    /**
     * Returns true if the given object is an instance of RepositoryDockerGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RepositoryDockerGroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RepositoryDockerGroup.__pulumiType;
    }

    /**
     * docker contains the configuration of the docker repository
     */
    public readonly docker!: pulumi.Output<outputs.RepositoryDockerGroupDocker>;
    /**
     * Configuration for repository group
     */
    public readonly group!: pulumi.Output<outputs.RepositoryDockerGroupGroup>;
    /**
     ...
     */
    public readonly storage!: pulumi.Output<outputs.RepositoryDockerGroupStorage>;
    ...
    constructor(name: string, argsOrState?: RepositoryDockerGroupArgs | RepositoryDockerGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RepositoryDockerGroupState | undefined;
            ...
            const args = argsOrState as RepositoryDockerGroupArgs | undefined;
        ...
        super(RepositoryDockerGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
