...
export class PrivilegeScript extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PrivilegeScriptState, opts?: pulumi.CustomResourceOptions): PrivilegeScript {
        return new PrivilegeScript(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nexus:index/privilegeScript:PrivilegeScript';

    /**
     * Returns true if the given object is an instance of PrivilegeScript.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PrivilegeScript {
    ...
    constructor(name: string, argsOrState?: PrivilegeScriptArgs | PrivilegeScriptState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PrivilegeScriptState | undefined;
            resourceInputs["actions"] = state ? state.actions : undefined;
            resourceInputs["description"] = state ? state.description : undefined;
            resourceInputs["name"] = state ? state.name : undefined;
            resourceInputs["scriptName"] = state ? state.scriptName : undefined;
        } else {
            const args = argsOrState as PrivilegeScriptArgs | undefined;
