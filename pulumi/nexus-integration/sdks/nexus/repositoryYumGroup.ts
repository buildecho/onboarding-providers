...
export class RepositoryYumGroup extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositoryYumGroupState, opts?: pulumi.CustomResourceOptions): RepositoryYumGroup {
        return new RepositoryYumGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nexus:index/repositoryYumGroup:RepositoryYumGroup';

    /**
     * Returns true if the given object is an instance of RepositoryYumGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RepositoryYumGroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RepositoryYumGroup.__pulumiType;
    }

    /**
     * Configuration for repository group
     */
    public readonly group!: pulumi.Output<outputs.RepositoryYumGroupGroup>;
    /**
     ...
     */
    public readonly storage!: pulumi.Output<outputs.RepositoryYumGroupStorage>;
    /**
     * Contains signing data of repositores
     */
    public readonly yumSigning!: pulumi.Output<outputs.RepositoryYumGroupYumSigning | undefined>;
    ...
    constructor(name: string, argsOrState?: RepositoryYumGroupArgs | RepositoryYumGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RepositoryYumGroupState | undefined;
            ...
            const args = argsOrState as RepositoryYumGroupArgs | undefined;
        ...
        super(RepositoryYumGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
